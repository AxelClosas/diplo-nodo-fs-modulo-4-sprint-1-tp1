export default function TeamCard({ title, img, desc, link}) {
  console.log(title, img, desc, link)
  return (
    <article className="bg-[#f8f9fa] overflow-hidden rounded-lg shadow-lg transition-transform duration-300 hover:-translate-y-2 hover:duration-300"
    >
